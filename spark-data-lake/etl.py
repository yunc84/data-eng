...
def create_spark_session():
    """Returns the initiated Spark session."""
    spark = SparkSession \
        .builder \
...
def process_song_data(spark, input_data, output_data):
    """Processes song data.
    Inputs: Spark session, path of input files, path of output
    Return: none"""
...
def process_log_data(spark, input_data, output_data):
    ...
    songplays_table = df['start_time', 'userId', 'level', 'song_id', \
